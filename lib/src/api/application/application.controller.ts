...
export class ApplicationController {
  ...
  @Patch()
  async updateApplication(@Body() body: ApplicationDto): Promise<ApiResponse<unknown>> {
  ...
  @Delete("/:id")
  public async deleteApplication(@Param("id") id: string): Promise<ApiResponse<unknown>> {
