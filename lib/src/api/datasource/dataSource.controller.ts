...
export class DataSourceController {
  ...
  @Get("/heartbeat")
  async checkConnection(@Query("id") id: string): Promise<ApiResponse<DataSourceConnStatus>> {
  ...
  @Delete()
  public async removeDataSource(@Query("id") id: string): Promise<ApiResponse<unknown>> {
