...
export const OptionsCollapseGroup = ({
  ...
  return (
    <div className="mb-2 p-3 pb-0 text-sm w-full flex flex-col cursor-pointer rounded bg-primary">
      <div className="flex flex-row items-center gap-x-3 justify-between w-full pr-3">
        <div className="flex flex-row item-center gap-x-2" onClick={() => setCollapsed(!collapsed)}>
      ...
      {!collapsed && (
        <div className="p-3 pt-5 text-primary">{children}</div>
      )}
